        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-ink/45 px-4 py-6">
          ...
          >
            ...
            <form action={createAnalysisRun} className="mt-5 grid gap-5">
              ...
              <fieldset className="grid gap-3">
                <legend className="text-sm font-medium text-ink">Target lessicali opzionali</legend>
                <div className="grid gap-3 md:grid-cols-2">
                  <label className="grid gap-1 text-sm">
                    <span className="font-medium text-ink">Parole da monitorare</span>
                    <textarea
                      name="parole_target"
                      rows={4}
                      placeholder="Es. 零度共情者, 案件, 真相"
                      className="rounded-md border border-stone-300 px-3 py-2 text-stone-900 outline-none focus:border-cinnabar"
                    />
                    <span className="text-xs text-stone-500">Una per riga o separate da virgola.</span>
                  </label>

                  <label className="grid gap-1 text-sm">
                    <span className="font-medium text-ink">Costrutti o frasi da monitorare</span>
                    <textarea
                      name="costrutti_target"
                      rows={4}
                      placeholder="Es. 因为...所以, 不是...就是"
                      className="rounded-md border border-stone-300 px-3 py-2 text-stone-900 outline-none focus:border-cinnabar"
                    />
                    <span className="text-xs text-stone-500">Usa frasi esatte o formule che vuoi verificare.</span>
                  </label>
                </div>
              </fieldset>
