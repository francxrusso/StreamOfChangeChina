alter table episodi
  add column if not exists analisi_tematica_parole text,
  add column if not exists analisi_emozioni text;
...
select
  ...
  episodi.analisi_tematica_parole,
  episodi.analisi_emozioni,
  episodi.descrizione
from episodi
